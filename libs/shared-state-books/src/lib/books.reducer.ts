...
/* export const selectActiveBook__bad__performance = (state: State) => {
...
/* export const selectEarningsTotals__bad_performance = (state: State) => {
  const books = selectAll(state)
...
export const selectEarningsTotals = createSelector(
  selectAll,
  calculateBooksGrossEarnings // Passing books directly to the method
);
